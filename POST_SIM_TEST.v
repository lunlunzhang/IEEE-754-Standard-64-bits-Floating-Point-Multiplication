...
`define SDFFILE    "../Innovus/CHIP.sdf"    // Modify your sdf file name here
`define cycle 0.42
...
`ifdef SDF
initial $sdf_annotate(`SDFFILE, TEST.CHIP);
`endif
...
begin 
  $display("\n\n**********************");
  $display("cycle time = %1.3f", CYCLE);
  $display("error_count = %3d", err_count);
  $display("**********************\n\n"); 
end
